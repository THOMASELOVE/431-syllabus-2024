...
All Labs should be turned in by the deadline specified on the [Course Calendar](https://thomaselove.github.io/431-2024/calendar.html). In this class, it is far better to turn in timely, but only partially complete work than nothing at all. We don't give extensions on Labs. Instead, we use the following grading policy.
